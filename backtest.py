import config
import backtrader, pandas, mysql.connector
...
class OpeningRangeBreakout(backtrader.Strategy):
    ...
    def stop(self):
        ...
        self.profit += self.broker.getvalue() - 100000
...
if __name__ == '__main__':
    ...
    for stock in stocks:
        ...
        dataframe = pandas.read_sql("""
            ...
            where stock_id = %s
            and SUBSTRING_INDEX(datetime, 'T', -1) >= '09:30:00' 
            and SUBSTRING_INDEX(datetime, 'T', -1) < '16:00:00'
            order by datetime asc
        """, conn, params=(stock['stock_id'],), index_col='datetime', parse_dates=['datetime'])
        ...
        strat = cerebro.run()
        profit = strat[0].profit
        print(f"Profit: {profit}")
        
        # Add profit to overall balance
        overall_balance += profit
        #cerebro.plot()
    print(f"Final overall balance: {overall_balance}")
